...
export default function SplashCursor({
  ...
  TRANSPARENT = true,
  /** 0–1: baja la intensidad visual del fluido sin tocar la simulación (p. ej. 0.5 más suave). */
  overlayOpacity = 1,
}) {
  ...
  useEffect(() => {
    ...
    const PALETTE = [
      { r: 0.322 * 0.20, g: 0.153 * 0.20, b: 1.0   * 0.20 },  // #5227FF
      { r: 1.0   * 0.20, g: 0.624 * 0.20, b: 0.988 * 0.20 },   // #FF9FFC
      { r: 0.706 * 0.20, g: 0.592 * 0.20, b: 0.812 * 0.20 },   // #B497CF
    ];
    let paletteIdx = 0;

    function generateColor() {
      const base = PALETTE[paletteIdx % PALETTE.length];
      paletteIdx++;
      const jitter = 0.15;
      return {
        r: base.r + (Math.random() - 0.5) * jitter * base.r,
        g: base.g + (Math.random() - 0.5) * jitter * base.g,
        b: base.b + (Math.random() - 0.5) * jitter * base.b,
      };
    }
