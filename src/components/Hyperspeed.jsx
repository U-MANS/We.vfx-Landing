...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    const islandFragment = roadBaseFragment.replace('#include <roadMarkings_vars>', '').replace('#include <roadMarkings_fragment>', '');
  ...
  return <div ref={hyperspeed} className="hyperspeed-container" />;
};
